...
Source0  : https://files.pythonhosted.org/packages/1e/88/e2f93c5738a4c1f56a458fc7a5b1676fc31dcdbb182bef6b40a141c17d66/gunicorn-22.0.0.tar.gz
...
%prep
%setup -q -n gunicorn-22.0.0
cd %{_builddir}/gunicorn-22.0.0
pushd ..
cp -a gunicorn-22.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713366307
