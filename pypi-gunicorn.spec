...
%prep
%setup -q -n gunicorn-23.0.0
cd %{_builddir}/gunicorn-23.0.0
pushd ..
cp -a gunicorn-23.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723474679
...
cp %{_builddir}/gunicorn-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gunicorn/61fd607b8e21cb0708dc00524cac538c3db17f18 || :
cp %{_builddir}/gunicorn-%{version}/NOTICE %{buildroot}/usr/share/package-licenses/pypi-gunicorn/fbd02b2ce46a1aafcd1edc82f163d8c79a7e7c58 || :
...
/usr/share/package-licenses/pypi-gunicorn/61fd607b8e21cb0708dc00524cac538c3db17f18
/usr/share/package-licenses/pypi-gunicorn/fbd02b2ce46a1aafcd1edc82f163d8c79a7e7c58
